...
- **Fix Applied**: Updated `plot_moga_summary()` in [`src/nkm/moga.py`](file:///home/cspark/Work/projects/nkm/src/nkm/moga.py) to fall back to `least_infeasible_f` when `pareto_f` is empty.
- **Verification**:
