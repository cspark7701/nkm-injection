...
## Summary
- **CLI Option Standardization**: Replaced `-p, --parallel N` in [`scripts/run_full_production_simulation.sh`](file:///home/cspark/Work/projects/nkm-injection/scripts/run_full_production_simulation.sh) with `-w, --workers W Number of parallel CPU worker cores`.
